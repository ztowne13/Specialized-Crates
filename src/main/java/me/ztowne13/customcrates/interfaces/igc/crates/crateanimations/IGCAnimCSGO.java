...
public class IGCAnimCSGO extends IGCAnimation {
    ...
    public void openMenu() {
        ...
        ib.setItem(7, new ItemBuilder(XMaterial.PAPER).setDisplayName("&aclose-speed")
        ...
        ib.setItem(12, new ItemBuilder(XMaterial.REDSTONE_TORCH).setDisplayName("&aidentifier-block")
        ...
        ItemBuilder fillerBlocks =
                new ItemBuilder(XMaterial.ENDER_CHEST).setDisplayName("&aAdd new filler-blocks").setLore("&7Current values: ");
        ...
        ib.setItem(15, fillerBlocks.setDisplayName("&aRemove existing filler-blocks"));

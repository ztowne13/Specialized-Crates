    ...
    public void manageClick(int slot)
    {
        switch (slot)
        {
            ...
            case 6:
                ...
                ChatUtils.msg(getP(), "&eIt's very similar to just drag and drop but not exactly the same. Click any blank space " +
                ...
                ChatUtils.msg(getP(), "&eIn this menu, click the 'paper' to add more pages to the preview menu. This is if " +
                        "you have more than 54 rewards or if you want to make it really fancy!");
                ChatUtils.msg(getP(), "&6&lForward / Backwards Buttons");
                ChatUtils.msg(getP(), "&eIf you only have one page, you can ignore all of this: these buttons are optional" +

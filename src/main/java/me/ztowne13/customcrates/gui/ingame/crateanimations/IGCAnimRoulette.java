...
public class IGCAnimRoulette extends IGCAnimation
{
	...
	public void open()
	{
		...
		ItemBuilder fillerBlocks = new ItemBuilder(Material.ENDER_CHEST, 1, 0).setName("&aAdd new random-blocks").setLore("&7Current values: ");
	...
	public void manageClick(int slot)
	{
		switch(slot)
		{
			...
			case 23:
				...
				break;
			case 24:
				new InputMenu(getCc(), getP(), "remove random-blocks", "Existing filler-blocks: " + (fc.contains(crateType.getPrefix() + ".filler-blocks") ? fc.getStringList(crateType.getPrefix() + ".filler-blocks") : "none"), String.class, this);
				break;
		}
	}

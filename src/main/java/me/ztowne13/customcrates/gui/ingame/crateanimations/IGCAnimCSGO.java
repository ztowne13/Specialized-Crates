...
public class IGCAnimCSGO extends IGCAnimation
{
    ...
    public void open()
    {
        ...
        ib.setItem(16, new ItemBuilder(Material.PAPER, 1, 0).setName("&aclose-speed")
                .addLore(getcVal() + getString("close-speed")));
        ib.setItem(20, new ItemBuilder(Material.NOTE_BLOCK, 1, 0).setName("&atick-sound")
                .addLore(getcVal() + getString("tick-sound")));
        ib.setItem(21, new ItemBuilder(DynamicMaterial.REDSTONE_TORCH, 1).setName("&aidentifier-block")
                .addLore(getcVal() + getString("identifier-block")));
        ...
        switch (slot)
        {
            ...
            case 16:
                new InputMenu(getCc(), getP(), "close-speed", getString("close-speed"),
                        "How fast the, neat, 'close' animation will display. Set to -1 to not have a 'close' animation.",
                        Integer.class, this);
                break;
            case 20:

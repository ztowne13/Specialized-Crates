...
public class IGCAnimOpenChest extends IGCAnimation
{
    ...
    public void open()
    {
        ...
        ib.setItem(13, new ItemBuilder(Material.PAPER, 1, 0).setName("&achest-open-duration")
                .addLore(getcVal() + getString("chest-open-duration"))
                .addAutomaticLore("&f", 30, "How long the chest will appear to be open for"));
        ib.setItem(14, new ItemBuilder(Material.PAPER, 1, 0).setName("&aearly-reward-hologram")
                .addLore(getcVal() + getString("early-reward-hologram"))
                .addAutomaticLore("&f", 30, "Should the reward-hologram play early with the animation for added effect?"));
        ib.setItem(15, new ItemBuilder(Material.PAPER, 1, 0).setName("&areward-hologram-delay")
                .addLore(getcVal() + getString("reward-hologram-delay")).addAutomaticLore("&f", 30,

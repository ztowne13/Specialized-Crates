...
{
    public static ItemStack loadItem(String s, StatusLogger sl, StatusLoggerEvent invMaterial, StatusLoggerEvent invByt,
                                     StatusLoggerEvent invalid, StatusLoggerEvent success)
    {
        ...
        try
        {
            ...
            return new ItemBuilder(dynMat, 1).get();
        }
        catch (Exception exc)
        {
    ...
    public static double loadDouble(String s, double defValue, StatusLogger sl, StatusLoggerEvent success,
    ...
    public static boolean loadBoolean(String s, boolean defValue, StatusLogger sl, StatusLoggerEvent success,
                                      StatusLoggerEvent invalid)
    {

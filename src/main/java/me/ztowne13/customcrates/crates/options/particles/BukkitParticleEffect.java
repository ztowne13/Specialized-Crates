...
public class BukkitParticleEffect extends ParticleData
{
	...
	public void display(Location l)
	{
		...
		else
		{
			...
			{
				l.getWorld().spawnParticle(particle, LocationUtils.getLocationCentered(l), getAmount(), isHasAnimation() ? 0 : getOffX(), isHasAnimation() ? 0 : getOffY(), isHasAnimation() ? 0 : getOffZ(), getSpeed());
			}
		}
	}

...
import me.ztowne13.customcrates.utils.VersionUtils.Version;
...
public enum EntityType {
    // v1.8
    PLAYER(2, Version.v1_8),
    SPIDER(1, Version.v1_8),
    GIANT(2, Version.v1_8),
    GHAST(3, Version.v1_8),
    BLAZE(2, Version.v1_8),
    ENDER_DRAGON(5, Version.v1_8),
    GUARDIAN(2, Version.v1_8),
    SQUID(1, Version.v1_8),
    BAT(.5, Version.v1_8),
    CAVE_SPIDER(.5, Version.v1_8),
    CHICKEN(1, Version.v1_8),
    COW(1, Version.v1_8),
    CREEPER(2, Version.v1_8),
    ENDERMAN(2.9, Version.v1_8),
    ENDERMITE(.5, Version.v1_8),
    HORSE(1.2, Version.v1_8),
    IRON_GOLEM(2.7, Version.v1_8),
    MAGMA_CUBE(1.7, Version.v1_8),
    MUSHROOM_COW(1.4, Version.v1_8),
    OCELOT(.5, Version.v1_8),
    PIG(.8, Version.v1_8),
    PIG_ZOMBIE(2, Version.v1_8),
    RABBIT(.5, Version.v1_8),
    SHEEP(1.2, Version.v1_8),
    SILVERFISH(.5, Version.v1_8),
    SKELETON(2, Version.v1_8),
    SLIME(1.7, Version.v1_8),
    SNOWMAN(2, Version.v1_8),
    VILLAGER(2, Version.v1_8),
    WITCH(2, Version.v1_8),
    WITHER(3.5, Version.v1_8),
    WOLF(.8, Version.v1_8),
    ZOMBIE(2, Version.v1_8),

    // v1.9
    SHULKER(2, Version.v1_9),

    // v1.10
    POLAR_BEAR(2, Version.v1_10),

    // v1.11
    ELDER_GUARDIAN(2, Version.v1_11),
    ...
    // v1.12
    ILLUSIONER(2, Version.v1_12),
    PARROT(2, Version.v1_12),

    // v1.13
    TURTLE(2, Version.v1_13),
    PHANTOM(2, Version.v1_13),
    TRIDENT(2, Version.v1_13),
    COD(2, Version.v1_13),
    SALMON(2, Version.v1_13),
    PUFFERFISH(2, Version.v1_13),
    TROPICAL_FISH(2, Version.v1_13),
    DROWNED(2, Version.v1_13),
    DOLPHIN(2, Version.v1_13),

    // v1.14
    CAT(2, Version.v1_14),
    PANDA(2, Version.v1_14),
    PILLAGER(2, Version.v1_14),
    RAVAGER(2, Version.v1_14),
    TRADER_LLAMA(2, Version.v1_14),
    WANDERING_TRADER(2, Version.v1_14),
    FOX(2, Version.v1_14),
    ...
    // v1.16
    ZOMBIFIED_PIGLIN(2, Version.v1_16),
    HOGLIN(2, Version.v1_16),
    PIGLIN(2, Version.v1_16),
    STRIDER(2, Version.v1_16),
    ZOGLIN(2, Version.v1_16);
...
//    AREA_EFFECT_CLOUD(2, VersionUtils.Version.v1_9);
    ...
    EntityType(double height, Version minimumVersion) {
        this.height = height;
        this.minimumVersion = minimumVersion;
    }

    public static EntityType getEnum(String name) {
        try {
            EntityType ent = valueOf(name.toUpperCase());
    ...
    public static List<EntityType> enumValues() {
